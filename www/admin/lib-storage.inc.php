...
+---------------------------------------------------------------------------+
$Id: lib-storage.inc.php 62345 2010-09-14 21:16:38Z chris.nutting $
*/
...
function phpAds_ImageStore($type, $name, $buffer, $overwrite = false)
{
	...
	if ($type == 'web') {
		...
		// ***********************************************************************************************************************************
		if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAJRHWTPOPIUS2G2PA');
		if (!defined('awsSecretKey')) define('awsSecretKey', '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');
